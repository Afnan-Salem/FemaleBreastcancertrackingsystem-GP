		...
		<div class="grid_10 floatright " >
				<div class="box round first">
					...
					<div class="block">
						...
						<?php
						$result=$_SESSION['prescriptions'];
						foreach ($result as $x)
						{ //loop the array
							echo '<tr class="odd gradeX">';
							echo '<td><form class="formT" name="prescription" method="post" action="../controller/patientPrescriptionController.php">
								<div class ="wrapButton">
								<input type="hidden" name="id" value="' . $x['PRESID'].'">
								<input class="button" name="view" type="submit" value="عرض" ></div>
								</form></td>';
							echo '<td>' . $x['INITIATION_DATE'] . '</td>';
							echo '</tr>';
						}
						?>
						</tbody>
