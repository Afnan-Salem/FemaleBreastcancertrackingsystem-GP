...
<link rel="stylesheet" href="assets/css/calendar.css" />
    ...
    <script src="../controller/patientManagement.js"></script>
    <script src="css/drpatient.css"></script>
</head>
<body>
<div class="container_12">
    <div class="grid_12 header-repeat">
        <div id="branding">
            <!-- logo pic -->
            <div class="floatleft">
                <img src="img/newlogo.PNG" alst="Logo" class="logo"/>
    ...
    <div class="box round first" id = "DRpateients">
        ...
        <div class="block" ng-controller = "DRpateientsCotroller">
            ...
            <table class="data display" >
                <tbody>
                <tr ng-repeat="p in patients | filter : filterPatients track by $index">
                    <td>
                        <div class="message stuff">
                            <a>
                                <span class="glyphicon glyphicon-remove" ng-click="prefere(p.PID,p.prefered);" style="float: right;"></span>
                            </a>
                            <?php
                            $ID ='{{p.PID}}';
                            echo '<a href="../view/taskcontroller.php?patientID='.$ID.'">';
                            ?>
                                <h5>ID : {{p.PID}}</h5>
                                <ul>
                                    <li>Name : {{p.FNAME}}&nbsp;{{p.MNAME}}&nbsp;{{p.LNAME}}</li>
