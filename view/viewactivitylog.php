...
<head>
    <meta charset="UTF-8" />
    <title>Activity log Notifications</title>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                echo '<li class="list-group-item">' .$i['NCONTENT']. ' , by ' .$i['NAME']. ' at '  .$i['TIMEDATE'].'</li>';
                                    echo '</ul>';}
                                ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                {
                                    echo '<ul class="list-group">';
                                    echo '<li class="list-group-item">' .$x['NCONTENT']. ' by ' .$x['NAME']. ' at '  .$x['TIMEDATE']. '</li>';
                                    echo '</ul>';}
                                ?>
                            </div>
                        </div>
