<?php
session_start();
$unseen = $_SESSION['unseen'];
$seen = $_SESSION['seen'];
$unseen2 = $_SESSION['unseen2'];
$seen2 = $_SESSION['seen2'];
$type = $_GET['type'];
$type2 = 'd';
include_once '../model/drNotificationModel.php';
$model = new drNotificationModel();
$model->_update($unseen,$type2);
    ...
    <div class="grid_10">
        ...
        <div class="box round first">
            <?php
             if($type == 'r')
             {
                 echo ' <h2>Reminder Notifications</h2>';
             }
            else
            {
                echo ' <h2>Danger Cases Notifications</h2>';
            }
            ?>
            <div class="panel-body">
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" > New Notifications </a>
                            </h4>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <?php
                                    ...
                                    {
                                        $n=1;
                                        for($x=0;$x<count($unseen);$x=$x+8) {
                                            echo '<ul class="list-group">';
                                            echo 'DR.' . $unseen[$x + 3] . ' you have ' . $unseen[$x + 5] .
                                                ' with patient:' . $unseen[$x + 1] . ' in ' . $unseen[$x + 7];
                                        }
                                    }
                                    else
                                    {
                                        $n=1;
                                        for($x=0;$x<count($unseen2);$x=$x+8) {
                                            echo '<ul class="list-group">';
                                            echo 'DR.' . $unseen2[$x + 3] . ' you have ' . $unseen2[$x + 5] .
                                                ' with patient:' . $unseen2[$x + 1] . ' in ' . $unseen2[$x + 7];
                                        }
                                    }
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> Old Notifications </a>
                            </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                {
                                    $n=1;
                                    for($x=0;$x<count($seen);$x=$x+8) {
                                        echo '<ul class="list-group">';
                                        echo 'DR.' . $seen[$x + 3] . ' you have ' . $seen[$x + 5] .
                                            ' with patient:' . $seen[$x + 1] . ' in ' . $seen[$x + 7];
                                    }
                                }
                                else
                                {
                                    $n=1;
                                    for($x=0;$x<count($seen2);$x=$x+8) {
                                        echo '<ul class="list-group">';
                                        echo 'DR.' . $seen2[$x + 3] . ' you have ' . $seen2[$x + 5] .
                                            ' with patient:' . $seen2[$x + 1] . ' in ' . $seen2[$x + 7];
                                    }
                                }
                                ?>
                            </div>
                ...
                <form action="customizeControl.php">
