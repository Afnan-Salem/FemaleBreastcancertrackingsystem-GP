...
<head>
    <meta charset="UTF-8" />
    <title>Archieved Patients</title>
    ...
    <script src="../controller/ArchievedPatient.js"></script>
    ...
    <div class="grid_10">
        <div class="box round first" id = "DRpateients">
            ...
            <div class="block" ng-controller = "DRpateientsCotroller">
                ...
                <div><form action="../view/drpatient.php"><button class="btn btn-primary btn" >Back</button></form></div>
                <br><br>
